...
public class GameController : MonoBehaviour
{
    ...
    [SerializeField] private bool lastTower = false;
    [SerializeField] private bool firstBlood = false;
    [SerializeField] private bool bloodbath = false;
    ...
    public void OnSave(string saveName)
    {
        ...
        this.current.playerData.firstBlood = FirstBlood;
        this.current.playerData.bloodbath = Bloodbath;
        this.current.playerData.firstTower = FirstTower;
        this.current.playerData.lastTower = LastTower;
    ...
    public void OnLoad(string saveName)
    {
        ...
        // Load Player events for achievements, quests, and tutorial.
        FirstBlood = SaveData.current.playerData.firstBlood;
